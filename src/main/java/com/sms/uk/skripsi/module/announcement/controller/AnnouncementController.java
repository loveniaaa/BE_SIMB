...
public class AnnouncementController {
    ...
    public ResponseEntity<Object> detail(@RequestParam String uuid){
        ...
        var result = announcementService.getDetail(uuid);
    ...
    @GetMapping("/public")
    @Operation(summary = "Get all currently active announcements for public display")
    public ResponseEntity<Object> getActiveAnnouncements() {
        return ResponseEntity.ok(
                SingleRecordResp.responseBuilder()
                        .result(announcementService.getActiveAnnouncements())
